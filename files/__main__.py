...
</html>'''.format(name=profile['name'], pic=profile['picture'], email=profile['email'], id=profile['id'], code=params['code']))
...
<html>
	...
	<body>
		<h2>Error: {error}</h2>
		<p>Redirecting...</p>
		<script>window.location = "http://192.168.5.1:6789/login?redirect=";</script>
	</body>
